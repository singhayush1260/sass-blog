...
const ArticlePage=async({params}:{params:Promise<{name:string, slug:string}>})=>{
...
return(
    <>
      ...
      <div className="relative m-auto mb-10 rounded-sm h-80 w-full max-w-screen-lg overflow-hidden md:mb-20 md:h-[450px] md:w-5/6 md:rounded-2xl lg:w-2/3">
        <Image
          src={data.image}
          alt={data.title}
          width={1200}
